...
```json
{
  ...
  "品質管理": {
    "description": [
      "客戶反映產品問題 → 問卷/客服系統記錄 → 啟動8D或品保流程",
      "抽驗產品發現瑕疵 → 紀錄不良品 → 通報相關單位調查並封存"
    ],
    "status": true
  },
  "倉儲管理": {
    "description": [
      "接收進貨商品 → 上架入庫管理 → 完成出庫指令與檢貨 → 盤點與異常處理"
    ],
    "status": true
  },
  "生產管理": {
    "description": [
      "規劃與控制生產流程，確保產能達標並提升製造效率。"
    ],
    "status": false
  },
  "客戶服務": {
    "description": [
      "顧客聯繫客服 → 分類需求與問題 → 回覆與後續追蹤"
    ],
    "status": true
  },
  "採購管理": {
    "description": [
      "優化供應商管理與採購流程，確保成本與交期穩定。"
    ],
    "status": false
  },
  "設備維護": {
  ...
  "能源管理": {
    "description": [
      "控管電用水等資源使用，達成節能減碳與成本節約。"
    ],
    "status": false
  },
  "物流與配送": {
    "description": [
      "整合配送路線與物流資源，確保運輸的效率與準確性。"
    ],
    "status": false
  },
  "研發與創新": {
    "description": [
      "推動新產品開發與流程創新，強化競爭力與市場影響力。"
    ],
    "status": false
  },
  "財務管理": {
  ...
  "人力資源": {
    "description": [
      "規劃招募、培訓與考核制度，促進員工發展與組織成長。"
    ],
    "status": true
  },
  "數據安全與治理": {
    "description": [
      "建立資料保護與權限控管機制，確保資訊正確、安全合規。"
    ],
    "status": false
  }
}
